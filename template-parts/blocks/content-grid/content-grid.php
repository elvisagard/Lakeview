...
// Background color
$theme_bg = get_field('theme_bg') ?: '';
$custom_bg = get_field('custom_bg') ?: null;
$style='';
$bg_clr_style =" ";
if($custom_bg){
    $theme_bg = null;
    $style .= ' '.' background-color:'.$custom_bg.';';
}else{
    $style = null;
    $custom_bg = null;
    $className .= ' '.$theme_bg;
...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>" style="<?php echo esc_attr($style); ?>" <?php echo $section_attr; ?>>
