...
?>
       ...
       <div <?php echo $block_id; ?> class="<?php echo $block_classes; ?>" <?php echo $block_attr; ?>>
        ...
        // Load more settings
        $pagination = $this->settings['thumb_grid']['pagination'] ?: false;
        $pagination_type = $this->settings['thumb_grid']['pagination_type'] ?: 'numbers';
        $anchor_id = $this->settings['thumb_grid']['pagination_anchors'] ? $this->id : false;
